...
$(document).ready(function () {
    ...
    var $buythemediv = '<div class="all-demo alt-font sm-display-none"><a href="mailto:hello@webmasons.co?subject=Webmasons â€“ Creative Agency, Corporate and Portfolio Multi-purpose Websites - Quick Question"><i class="ti-email"></i><span>Quick Question?</span></a></div>';
