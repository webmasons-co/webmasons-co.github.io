...
$(document).ready(function () {
    ...
    var $buythemediv = '<div class="buy-theme alt-font sm-display-none"><a href="https://webmasons.co" target="_blank"><i class="ti-shopping-cart"></i><span>Buy Theme</span></a></div><div class="all-demo alt-font sm-display-none"><a href="mailto:hello@webmasons.co?subject=Crossover Blog“ Creative Agency, Corporate and Portfolio Multi-purpose Template - Quick Question"><i class="ti-email"></i><span>Quick Question?</span></a></div>';
